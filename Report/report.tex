...
\begin{itemize}
    \item \textbf{$L(\mathcal{A}_1)$}: The language of all words over $\{a, b\}$ that \textbf{start with the letter $a$} and \textbf{end with an odd number of consecutive $b$'s}. 
        
    \item \textbf{$L(\mathcal{A}_2)$}: The language of all words over $\{a, b\}$ that \textbf{end with the substring $aa$}. 
